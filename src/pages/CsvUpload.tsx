...
const initialCsvFiles: CsvFile[] = [
  {
    id: "pacientes",
    name: "Pacientes",
    description: "Datos de pacientes registrados y su información demográfica",
    lastUpdated: null,
    status: "idle",
    progress: 0,
  },
  {
    id: "tratamientos",
    name: "Tratamientos",
    description: "Catálogo de tratamientos y procedimientos estéticos",
    lastUpdated: null,
    status: "idle",
    progress: 0,
  },
  {
    id: "citas",
    name: "Citas",
    description: "Historial de citas y agenda de consultas",
    lastUpdated: null,
    status: "idle",
    progress: 0,
  },
  ...
  },
  {
    id: "inventario",
    name: "Inventario",
    description: "Stock de productos y materiales",
    lastUpdated: null,
    status: "idle",
    progress: 0,
  },
